...
Entando supports communication between micro frontends using [Custom Events](https://developer.mozilla.org/en-US/docs/Web/API/CustomEvent), an established web standard. In this example, we’ll build two micro frontends.
- The first micro frontend will fire an event.
- The second micro frontend will intercept it.
