...
``` sh
kubectl apply -f https://raw.githubusercontent.com/entando/entando-releases/v7.5.2/dist/ge-1-1-6/namespace-scoped-deployment/cluster-resources.yaml
```
...
``` sh
curl -LJO https://raw.githubusercontent.com/entando/entando-releases/v7.5.2/dist/ge-1-1-6/samples/entando-operator-config.yaml
```
...
``` sh
kubectl -n YOUR-NAMESPACE apply -f https://raw.githubusercontent.com/entando/entando-releases/v7.5.2/dist/ge-1-1-6/namespace-scoped-deployment/namespace-resources.yaml
```
