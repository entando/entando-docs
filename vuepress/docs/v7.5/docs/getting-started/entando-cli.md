...
<EntandoCode> bash <(curl -L "https://get.entando.org/cli") --update --release="{{ $site.themeConfig.entando.fixpack.v75 }}" </EntandoCode>
...
||ent quickstart --release="{{ $site.themeConfig.entando.fixpack.v75 }}" | Use a specific release version for the install
