...
- Introduced the `HEADLESS_WIDGET_CONFIG` feature flag environment variable (see the [App Engine README](https://github.com/entando/app-engine/blob/v7.5.2/README.md) for details)
