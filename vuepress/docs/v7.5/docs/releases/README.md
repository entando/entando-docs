...
Entando 7.5 is an essential feature release with significant advances for Multitenancy and design and performance upgrades for the App Builder.
...
### Compatibility
* [Entando 7.5 Compatibility](https://auth.entando.com/entando-de-app/cmsresources/cms/documents/Entando_7.5_Compatibility.pdf)
...
### Infrastructure
- Entando 7.5 now supports integration with Kubernetes 1.26 - 1.28
