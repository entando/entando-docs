...
2. Now create a widget with the sample HTML code.  Enter into the following fields: 
    ...
    -   Select SAVE
    -   Note: the Custom UI Field is a freemarker template where you can put raw html and include freemarker logic, it allows you to import javascript, css, or any normal HTML
