...
[micro frontends](../../tutorials/micro-frontends/react) tutorials for more details and the [Entando JHipster Blueprint](../component-generator/blueprint-features.md) which makes customizing easier. You can also quickly [generate an Entando plugin here](../../tutorials/backend-developers/generate-microservices-and-micro-frontends.md). The generated project
