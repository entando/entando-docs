...
[micro frontends](../../tutorials/micro-frontends/react) tutorials for more details and explore [Entando JHipster Blueprint](../micro-frontends/generate-micro-frontends-from-a-database-entity/) which makes customizing easier. You can also quickly [generate an Entando plugin here](../../tutorials/backend-developers/generate-microservices-and-micro-frontends.md). The generated project
