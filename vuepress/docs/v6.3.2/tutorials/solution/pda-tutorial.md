...
- A Spring Boot microservice backend providing a pluggable interface for the injection of underlying processes or automation toolkits. The interfaces and steps for creating a new PDA backend implementation are described in further detail [here](../solution/pda-technical-guide.md).
...
[technical documentation](../solution/pda-technical-guide.md) for more on the JSON schema
implementation.
