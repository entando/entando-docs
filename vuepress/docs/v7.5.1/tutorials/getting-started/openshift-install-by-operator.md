...
<EntandoCode>oc apply -f https://raw.githubusercontent.com/entando/entando-releases/{{$site.themeConfig.entando.fixpack.v75}}/dist/ge-1-1-6/samples/openshift-catalog-source.yaml</EntandoCode>
...
7. Now go to `EntandoApp` and click `Create EntandoApp`
   ...
   - Select the EntandoApp version: `7.5.1`
