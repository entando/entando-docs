...
### Project Structure
   ...
   * `/bundle/plugins/conference-plugin.yaml` includes the plugin configuration and `healthCheckPath` provided by and pre-configured in SpringBoot. See [plugin definition](../../docs/ecr/ecr-bundle-details.md#plugin) for more information.
