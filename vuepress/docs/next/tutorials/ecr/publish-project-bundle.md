...
## Prerequisites
* [Install the Entando CLI](../../docs/reference/entando-cli.md) and run `ent check-env develop` to verify you have the necessary prerequisites in place (e.g. Java, npm, git, etc.). 
