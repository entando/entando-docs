...
| |[Microservices Environment Variables](#microservices-environment-variables)|No||Named Entando specific MS env variables |
...
| `SPRING_PROFILES_ACTIVE`| string | Application profile to use when the MS runs on Entando, differentiating dev vs prod at runtime. Automatically handled by a Spring Boot MS but can be manually managed if using another technology `stack` | default, prod |
    ...
    {...,
      "env": [
        { "name": "KEYCLOAK_AUTH_URL",
          "value": "http://demo71.k8s-entando.org/auth"
          },
        { "name": "KEYCLOAK_CLIENT_SECRET",
          "secretKeyRef": {
              "name": "clientSecret", 
              "key": "pn-343826ca-2f75f095-entandodemo-sd-banking-server-secret"
              "optional": "false"
            }
          },
        ...
        { "name": "SPRING_DATASOURCE_URL",
          "value": "jdbc:mysql://default-mysql-dbms-in-namespace-service.entando.svc.cluster.local:3306/pn_8bc2450b_0ba656a5_dv92__91652" 
        }  
      ]
    }
  ]
