...
[Click here for tutorials and instructions for deploying via operator hub](../../tutorials/get-started/openshift-install-by-operator-hub.md)
...
[Click here for tutorials on creating secrets and setting up TLS in your Entando Apps.](../../tutorials/get-started/openshift-install-by-operator-hub.md)
