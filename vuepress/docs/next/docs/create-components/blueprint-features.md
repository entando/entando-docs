...
* Try implementing an Entando Blueprint-- [Create microservices and micro frontents](../../tutorials/tu-create-components/mfe/react.md)
...
frontends, refer to [Create a React micro frontend widget](../../tutorials/tu-create-components/mfe/react.md).
...
to the [Authentication section](../consume-an-app/identity-management.md#authentication).
...
please refer to the section on [Widget communication](../../tutorials/tu-create-components/mfe/communication.md).
