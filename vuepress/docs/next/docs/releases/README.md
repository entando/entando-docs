...
- [Hub 3.1](../../tutorials/solution/entando-hub.md) brings the option to create private catalogs for each organization in an Entando Hub
...
- Numerous performance, security, and dependency imprvoements 
...
- [Redis](../tutorials/consume/mt-redis.md) is used for cache management, [Apache Solr](../../tutorials/consume/mt-solr.md) for enterprise search, and Entando's Content Delivery Server [CDS](TODO) for static asset and content delkivery
...
### Hub 3.1
- [Entando Hub](../../tutorials/solution/entando-hub.md) is now based on docker-based bundles
...
- Solr configuration is now accessible in the App Builder navigation, if Solr is enabled in the application
