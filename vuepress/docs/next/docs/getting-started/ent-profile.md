...
At a minimum, a profile must consist of the key-value pair specifying the application name and namespace. To run Entando, a Kubernetes context must be established and linked to an Entando profile.
