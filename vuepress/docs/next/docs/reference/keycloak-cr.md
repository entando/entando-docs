...
|`spec.dbms`| MySQL, PostgreSQL, or embedded (default). For Oracle, enter `none`-- [Configuring Keycloak with Oracle DBSM](../../tutorials/consume/external-id-management.md#next-steps). |
