...
For more information on docker-based bundles, see the [Bundle Details](../curate/bundle-details.md) page for specification and the guide on how to [upgrade to docker-based bundles](./bundle-upgrade.md). 
