...
```   
See [this tutorial](../../tutorials/tu-create-components/pb/publish-simple-bundle.md) for an example using `ent prj generate-cr`.
...
Instructions to export a bundle, including how to configure `env.json`, can be found in [this tutorial](../../tutorials/tu-create-components/pb/export-bundle-from-application.md).
