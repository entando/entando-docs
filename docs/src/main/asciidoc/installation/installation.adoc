...
[NOTE]
=====
For security purposes, you should only run this in a development environment. Doing so in production would expose all the endpoints of your application. See the following section for details.
=====
