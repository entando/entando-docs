...
== DIGITAL ASSETS
The Digital Assets section separates content into Images and Attachments via tabs below the filter area of the Digital Assets home screen.

.To add digital assets:

. *Drag and drop* a file onto the droppable area or just click *Browse your computer*.
+
image::cms_digital_assets_new.png[width='40%']
. Name the asset, and select a group and category.
+
image::cms_digital_assets_add.png[width='40%']
. Click *Upload*. The asset then appears in the asset list at the bottom of the Digital Assets screen.
...
+
image::cms_digital_assets_crop.png[]
...
+
image::cms_content_type_image.png[]
. Create a content based on the created  type.
+
image::cms_content_with_image.png[]
...
+
image::cms_content_image_add.png[]
