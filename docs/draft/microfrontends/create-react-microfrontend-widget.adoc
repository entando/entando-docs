...
NOTE: you could keep the original names in order to avoid potential caching issues, but then you will have to update the _Custom UI_ fields in the App Builder widget screen every time a new version of the widget is deployed.
